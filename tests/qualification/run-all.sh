...
titre "1/6 — Moteur serveur"
"$PHP_BIN" test-qualification.php
verdict $? "test-qualification.php"

titre "2/6 — Moteur navigateur, et son équivalence avec le serveur"
...
titre "3/6 — Tunnel de qualification, rejoué dans un navigateur"
...
titre "4/6 — Falsification : le serveur croit-il le navigateur ?"
"$PHP_BIN" test-falsification.php
verdict $? "test-falsification.php"

titre "5/6 — Contrôleur réel : le régime bloque-t-il avant enregistrement ?"
"$PHP_BIN" test-controller-regime.php
verdict $? "test-controller-regime.php"

titre "6/6 — Report des réponses vers les formulaires DP et PC"
...
if [ "$echecs" -eq 0 ]; then printf '\033[32mLes 6 bancs passent.\033[0m\n'; exit 0; fi
