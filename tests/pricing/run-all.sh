#!/usr/bin/env bash
#
# Lance les bancs d'essai des stratégies tarifaires par type serveur (Lot 1 incr. 6).
#
...
titre "1/1 — Stratégies tarifaires résolues par type serveur"
"$PHP_BIN" test-strategie.php
verdict "$?" test-strategie.php
