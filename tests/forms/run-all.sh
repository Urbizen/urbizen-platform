#!/usr/bin/env bash
#
# Lance les bancs d'essai du socle multi-formulaire (registre, à venir : routage).
#
#   ./run-all.sh
#
...
titre "1/1 — Registre des formulaires (liste blanche)"
"$PHP_BIN" test-registry.php
verdict "$?" test-registry.php
