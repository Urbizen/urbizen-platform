...
check( 'A · all() = exactement les deux formulaires livrés', array( 'localisation', 'conception' ) === FormRegistry::all() );
check( 'A · KNOWN inchangé (inventaire minimal)', array( 'localisation', 'conception' ) === FormRegistry::KNOWN );
...
check( 'C · la liste blanche est intacte après les tentatives', array( 'localisation', 'conception' ) === FormRegistry::all() );

// ======================================================================
// D · DOUBLONS (aucun écrasement silencieux)
// ======================================================================
check( 'D · réenregistrer « conception » est refusé', false === FormRegistry::register( 'conception' ) );
check( 'D · la liste reste inchangée après le doublon', array( 'localisation', 'conception' ) === FormRegistry::all() );
...
check( 'F · all() de nouveau = les deux formulaires livrés', array( 'localisation', 'conception' ) === FormRegistry::all() );
