#!/usr/bin/env bash
#
# Lance les bancs d'essai du bloc/shortcode Urbizen (raccordement de FormBlock
# aux renderers serveur, Lot 1 incrément 4).
#
#   ./run-all.sh
#
# Prérequis : PHP 8.1+. Aucune connexion réseau, aucune base de données, aucun
# WordPress installé : les fonctions WordPress employées sont doublées par le
# harnais de tests/submissions, réutilisé ici.
#
...
titre "1/1 — FormBlock raccordé aux renderers serveur"
"$PHP_BIN" test-formblock.php
verdict "$?" test-formblock.php
